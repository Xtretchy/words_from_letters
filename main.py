'''
Program: words_from_letters.py
Author(s): Oluwapelumi Soyombo
Date: 16.08.2020
'''
...
# collects input of letters from user,
# creates a list to store new words.
letters = input('Enter the letters (as one word): ').lower()
lst = []

# uses a library to find all permutations
# uses a loop to select sub-words as new permutation is made
